...
Implement the section 15 edge cases inside the step that owns each stage (input cases in step 3, fetching cases in steps 2 and 3, extraction cases in step 5, job cases in step 8), each with its unit test.
